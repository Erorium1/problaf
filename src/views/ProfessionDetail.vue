  ...
  data() {
    return {
      ...
      professionData: {
        ...
        agriculture: {
          title: 'Сельское хозяйство и экология',
          pages: {
            1: [
              {
                title: 'Агроном',
                descriptions: [
                  '-повышение урожая',
                  '-изучает почвы и растения, улучшает сельхозпроизводство.'
                ]
              },
              {
                title: 'Фермер',
                descriptions: [
                  '-работа на себя',
                  '-выращивает сельхозпродукцию или разводит животных.'
                ]
              },
              {
                title: 'Ветеринар',
                descriptions: [
                  '-помощь животным',
                  '-лечит и ухаживает за животными.'
                ]
              },
              {
                title: 'Зоотехник',
                descriptions: [
                  '-забота о животных',
                  '-занимается кормлением, разведением и содержанием скота.'
                ]
              }
            ],
            2: [
              {
                title: 'Инженер по сельхозтехнике',
                descriptions: [
                  '-техника на полях',
                  '-обслуживает и настраивает сельскохозяйственные машины.'
                ]
              },
              {
                title: 'Эколог',
                descriptions: [
                  '-защита природы',
                  '-следит за состоянием окружающей среды и её сохранением.'
                ]
              },
              {
                title: 'Лесник',
                descriptions: [
                  '-работа в природе',
                  '-охраняет леса, следит за порядком и животными.'
                ]
              },
              {
                title: 'Гидрометеоролог',
                descriptions: [
                  '-прогнозы погоды',
                  '-исследует климат и природные условия.'
                ]
              }
            ],
            3: [
              {
                ...
                descriptions: [
                  ...
                  '-разрабатывает способы сортировки и утилизации мусора.'
                ]
              },
              {
                ...
                descriptions: [
                  '-зелёная эстетика',
                  '-оформляет парки, сады и территории с растениями.'
                ]
              }
            ]
          }
