<template>
  <div class="test-view">
    <div class="back-button">
      <router-link to="/test/block2" class="btn-back">
    ...
    <div class="test-container">
      <div class="test-content">
        <div class="block-header">
          <h2>БЛОК 3: МОЙ ХАРАКТЕР</h2>
          <p class="block-description">
            Черты характера играют ключевую
            роль в выборе профессии.
            Кому-то ближе спокойствие, кому-то
            драйв, кто-то не может без порядка, а
            кто-то без творчества.
            Отвечай так, как ты себя чувствуешь на
            самом деле.
          </p>
        </div>
        ...
        <div class="questions">
          <div class="question-item">
            <p class="question-text">Я люблю порядок и чёткую организацию.</p>
          ...
          <div class="question-item">
            <p class="question-text">Я стараюсь сохранять оптимизм и поддерживать окружающих.</p>
            <div class="rating-buttons">
              <button v-for="n in 5" 
                      :key="n" 
                      class="rating-button"
          ...
          <div class="question-item">
            <p class="question-text">Я предпочитаю работать в одиночку.</p>
            <div class="rating-buttons">
              <button v-for="n in 5" 
                      :key="n" 
                      class="rating-button"
          ...
          <div class="question-item">
            <p class="question-text">Я сильно переживаю за других людей.</p>
            <div class="rating-buttons">
              <button v-for="n in 5" 
                      :key="n" 
                      class="rating-button"
          ...
          <div class="question-item">
            <p class="question-text">Мне важно, чтобы была чёткая инструкция и план.</p>
            <div class="rating-buttons">
              <button v-for="n in 5" 
                      :key="n" 
                      class="rating-button"
          ...
          <div class="question-item">
            <p class="question-text">Я легко приспосабливаюсь к новым условиям.</p>
            <div class="rating-buttons">
              <button v-for="n in 5" 
                      :key="n" 
                      class="rating-button"
          ...
          <div class="question-item">
            <p class="question-text">Я остро чувствую несправедливость.</p>
            <div class="rating-buttons">
              <button v-for="n in 5" 
                      :key="n" 
                      class="rating-button"
          ...
          <div class="question-item">
            <p class="question-text">Я часто размышляю о смысле происходящего.</p>
            <div class="rating-buttons">
              <button v-for="n in 5" 
                      :key="n" 
                      class="rating-button"
          ...
          <div class="question-item">
            <p class="question-text">Я терпелив(а) и внимателен(на) к деталям.</p>
            <div class="rating-buttons">
              <button v-for="n in 5" 
                      :key="n" 
                      class="rating-button"
          ...
          <div class="question-item">
            <p class="question-text">Я люблю рисковать и пробовать что-то новое.</p>
            <div class="rating-buttons">
              <button v-for="n in 5" 
                      :key="n" 
                      class="rating-button"
        ...
        <div class="navigation-buttons">
          <router-link to="/test/block2" class="nav-button prev">
